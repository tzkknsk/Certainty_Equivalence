...
if buttom:
     ...
     df = df.rename(columns={0: 'Subject_ID', 1: 'Question number', })
     ...
     st.download_button(
          label="結果を出力(csv)",
          data=csv,
          file_name= f'Certainty_Equivalence_Result.csv',
          mime='text/csv',
     )
